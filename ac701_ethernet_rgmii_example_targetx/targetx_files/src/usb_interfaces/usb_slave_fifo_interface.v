...
//150218: changed timeout from 20 to 120- still problematic
`define USB2FPGA_CS_MAX_LENGTH 1025 //=real+1. In this case, real is 512. max 255
`define USB2FPGA_CS_TIME_OUT 120 //max 255

`define USB2FPGA_DATA_MAX_LENGTH 1025 //=real+1. In this case, real is 512. max 255
`define USB2FPGA_DATA_TIME_OUT 120 //max 255

`define FPGA2USB_CS_MAX_LENGTH 1024 //max 255
`define FPGA2USB_CS_TIME_OUT 120 // max 255

`define FPGA2USB_DATA_MAX_LENGTH 1024 //max 1023
`define FPGA2USB_DATA_TIME_OUT 120 //max 255
