...
COPY klm_aurora_example_design.edf .\results\

ECHO Copying files from example design directory to the results directory
COPY ..\example_design\klm_aurora_example_design.ucf .\results\
CD results
...
ngdbuild klm_aurora_example_design

REM  -----------------------------------------------------------------------------
REM-------------------------------Run map-------------------------------------------

ECHO 'Running map'
map -detail klm_aurora_example_design -o mapped.ncd
...
ECHO INFO:Implementation is complete for klm_aurora_example_design
