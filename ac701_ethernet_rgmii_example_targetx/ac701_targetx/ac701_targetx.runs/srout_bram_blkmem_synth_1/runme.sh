...
HD_PWD=C:/Users/Jose Idlabs/Documents/ac701_ethernet_rgmii_example_targetx/ac701_targetx/ac701_targetx.runs/srout_bram_blkmem_synth_1
cd "$HD_PWD"
...
EAStep vivado -log srout_bram_blkmem.vds -m64 -mode batch -messageDb vivado.pb -notrace -source srout_bram_blkmem.tcl
