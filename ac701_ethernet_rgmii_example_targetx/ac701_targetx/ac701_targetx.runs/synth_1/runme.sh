...
HD_PWD=C:/Users/Jose Idlabs/Documents/ac701_ethernet_rgmii_example_targetx/ac701_targetx/ac701_targetx.runs/synth_1
cd "$HD_PWD"
...
EAStep vivado -log scrod_top_A5_KLM_9UMB.vds -m64 -mode batch -messageDb vivado.pb -notrace -source scrod_top_A5_KLM_9UMB.tcl
