...
HD_PWD=C:/Users/Jose Idlabs/Documents/ac701_ethernet_rgmii_example_targetx/ac701_targetx/ac701_targetx.runs/impl_1
cd "$HD_PWD"
...
EAStep vivado -log scrod_top_A5_KLM_9UMB.vdi -applog -m64 -messageDb vivado.pb -mode batch -source scrod_top_A5_KLM_9UMB.tcl -notrace
