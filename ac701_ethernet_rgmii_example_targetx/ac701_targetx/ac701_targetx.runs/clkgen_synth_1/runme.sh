...
HD_PWD=C:/Users/Jose Idlabs/Documents/ac701_ethernet_rgmii_example_targetx/ac701_targetx/ac701_targetx.runs/clkgen_synth_1
cd "$HD_PWD"
...
EAStep vivado -log clkgen.vds -m64 -mode batch -messageDb vivado.pb -notrace -source clkgen.tcl
